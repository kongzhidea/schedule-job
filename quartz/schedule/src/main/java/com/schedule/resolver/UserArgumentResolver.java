package com.schedule.resolver;

import com.schedule.interceptor.CLoginRequiredInterceptor;
 ...
 * User参数绑定
 * <p/>
 * 跟{@link CLoginRequiredInterceptor}配合，使得在Controller的方法中参数中 直接用{@code User user}
