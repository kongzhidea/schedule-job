...
CREATE TABLE `qrtz_job_details` (
  `SCHED_NAME` varchar(120) CHARACTER SET latin1 NOT NULL,
  `JOB_NAME` varchar(200) CHARACTER SET latin1 NOT NULL,
  `JOB_GROUP` varchar(200) CHARACTER SET latin1 NOT NULL,
  `DESCRIPTION` varchar(250) CHARACTER SET latin1 DEFAULT NULL,
  `JOB_CLASS_NAME` varchar(250) CHARACTER SET latin1 NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='quartz';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1  COMMENT='quartz';
...
CREATE TABLE `qrtz_simprop_triggers` (
  ...
  `DEC_PROP_1` decimal(13,13) DEFAULT NULL,
  `DEC_PROP_2` decimal(13,13) DEFAULT NULL,
